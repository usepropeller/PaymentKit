...
#define DefaultBoldFont IS_IOS7? [UIFont systemFontOfSize:17] : [UIFont boldSystemFontOfSize:17]
...
- (void)setup
{
    ...
    self.backgroundColor = IS_IOS7? [UIColor whiteColor] : [UIColor clearColor];
